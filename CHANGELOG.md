...
### Fixed
- **PDF Export**: Massively reduced the file size of generated PDF invoices and yearly overviews by enabling native compression and optimizing logo embedding.

## [1.0.29] - 2026-03-21

### Fixed
- **Build**: `main.rs` still referenced the old crate name `rechnung_lib` — updated to `vibebill_lib`.

## [1.0.28] - 2026-03-21

### Changed
- **Release Notes**: GitHub releases now display the relevant CHANGELOG section instead of a generic placeholder text.

### Fixed
- **Cargo.toml**: Crate was still named `rechnung` (v0.1.0) from the original project — renamed to `vibebill` (v1.0.27/1.0.28) to match the rest of the project.
